        ...
        <div className="flex-1">
          ...
          <div className="flex justify-center">
            <button
              ...
              } px-6 py-2 rounded border-2 border-indigo-600 text-indigo-600 font-semibold text-gray-600 w-24 uppercase focus:outline-none`}
            >
              AMD
            </button>
            <button
              ...
              } px-6 py-2 rounded border-2 border-indigo-600 text-indigo-600 font-semibold text-gray-600 w-24 uppercase focus:outline-none ml-6`}
            >
              INTEL
            </button>
          </div>
